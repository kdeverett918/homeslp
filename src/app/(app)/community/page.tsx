...
const SAMPLE_TOPICS = [
  ...
  { id: "4", author: "David K.", category: "wins" as const, title: "Dad just ate his first real meal in 3 months", preview: "After his stroke, he was on pureed everything. His SLP cleared him to move to soft & bite-sized last week. He had pasta tonight and smiled. (Always get SLP clearance before changing diet levels!)", replies: 21, likes: 67, time: "1 day ago" },
