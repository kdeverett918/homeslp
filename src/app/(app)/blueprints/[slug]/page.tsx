    ...
    <div className="max-w-3xl space-y-8">
        ...
        <div className="flex items-center gap-3 mb-3">
          <div
            className={`w-10 h-10 rounded-lg flex items-center justify-center ${
              bp.path === "child" ? "bg-rose-100" : "bg-sage-100"
            }`}
          >
      ...
      <section className="space-y-4">
        ...
        <div className="aspect-video rounded-xl overflow-hidden bg-muted">
          <iframe
            src={`https://www.youtube.com/embed/${bp.curatedMedia.youtubeVideoId}${
              bp.curatedMedia.startTimeSeconds
                ? `?start=${bp.curatedMedia.startTimeSeconds}`
                : ""
            }`}
        ...
        <div className="rounded-lg bg-muted/50 p-4 text-sm">
          ...
          <p className="text-muted-foreground">
            {bp.curatedMedia.kristineAnnotation}
          </p>
        </div>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          Print this and stick it on your fridge for quick reference during daily
          routines.
        </p>
          ...
          {bp.refrigeratorPdf.techniques.map((tech, i) => (
            <div key={i} className="rounded-xl border bg-card p-5 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                <strong>Tip:</strong> {tech.parentTip}
              </p>
            </div>
          ))}
        </div>
      ...
      <div className="rounded-lg bg-amber-50 border border-amber-200 p-4 text-sm text-amber-800">
        ...
        <p className="text-amber-700 mt-1">
          This content is for general educational purposes. It does not replace
          a professional evaluation or constitute medical advice. Always consult
