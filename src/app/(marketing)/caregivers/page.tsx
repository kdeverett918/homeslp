...
const faqItems = [
  {
    question: "My loved one has Parkinson's — is this for them?",
    answer:
      "Yes. Our adult path covers swallowing and communication challenges common in Parkinson's, stroke, TBI, and other neurological conditions. The strategies are broadly applicable.",
  },
  {
    question: "What is IDDSI?",
    answer:
      "IDDSI (International Dysphagia Diet Standardisation Initiative) is the global framework for classifying food textures and liquid thickness. We help you understand and prepare meals at any IDDSI level.",
  },
  {
    question: "Is this a replacement for therapy?",
    answer:
      "No. HomeSLP provides educational content to supplement professional care. Always follow the diet and exercise recommendations from your loved one's medical team.",
  },
  {
    question: "Can I share my EAT-10 scores with their doctor?",
    answer:
      "Absolutely! The EAT-10 tracker generates a printable report designed for sharing with healthcare providers.",
  },
  {
    question: "What if I need to change my loved one's diet level?",
    answer:
...
export default function CaregiversLanding() {
  return (
    <div>
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-b from-sage-50/80 to-background pt-16 pb-20 sm:pt-24 sm:pb-28">
          ...
          <SlideUp>
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-6 text-lg text-muted-foreground sm:text-xl max-w-2xl mx-auto">
                A licensed SLP&apos;s resource for caregivers. IDDSI recipes,
                swallowing exercises, communication tools, and weekly guidance —
                all in one place.
              </p>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <FadeIn>
            <p className="mt-8 text-center text-muted-foreground max-w-xl mx-auto">
              ...
              guidance. HomeSLP was built to change that.
            </p>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <FadeIn>
            <div className="mx-auto max-w-2xl text-center space-y-6">
              <div className="inline-flex items-center gap-3 rounded-2xl bg-gradient-to-r from-sage-50 to-rose-50 border px-6 py-3">
              ...
              <p className="text-muted-foreground">
                Every blueprint, recipe, exercise video, and communication tool on
                HomeSLP is created by a licensed Speech-Language Pathologist with
                clinical experience across hospital, rehabilitation, and
                outpatient settings.
              </p>
            </div>
          </FadeIn>
